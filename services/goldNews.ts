...
const VN_EXPRESS_RSS = 'https://vnexpress.net/rss/kinh-doanh/vang.rss'
...
function parseRssItems(xml: string, source: string): GoldNewsItem[] {
...
async function fetchVnExpressGold(): Promise<GoldNewsItem[]> {
  ...
  return parseRssItems(xml, 'VnExpress')
}
